				...
				<div class="card-body">
					...
					<input type="hidden" name="no" value="<?= $no ?>">
						...
						<div class="form-group col-lg-12">
							 ...
							 <option>Kepala Sub Bagian Perencanaan Dan Keuangan</option>
							 <option>Kepala Koperasi</option>
                             <option>Kepala Bidang usaha mikro</option>
							 <option>Kepala Bidang Ketenaga Kerjaan</option>
